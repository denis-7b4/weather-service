...
@Slf4j
public class ClientWeatherbit implements TemperatureRequest {

    private final String apiKey;
    static final String CURRENT_SERVICE = "Weatherbit.io";

    public ClientWeatherbit(String apiKeyWeatherbit) {
        this.apiKey = apiKeyWeatherbit;
    }
